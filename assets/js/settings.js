...
const originalLink = settingsEl.querySelector("#original-link");
...
function resetExample() {
  ...
  if (!linkToCurrentCountDownWrapperEl.classList.contains("hidden")) {
    linkToCurrentCountDownWrapperEl.classList.add("hidden");
  }
  linkToCurrentCountDownEl.href = "#";
  linkToCurrentCountDownEl.textContent = "";
  resetFormFields();
